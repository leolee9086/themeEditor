export class  kernelApiList{
	...
	this.set("POST", "/api/storage/removeLocalStorageVal", "removeLocalStorageVal","获取存储项")
	...
	this.set("POST", "/api/history/getDocHistory",  'getHistoryItems','获取历史条目')
    //大纲、书签与标签相关
	...
	//this.set("GET", "/snippets/*filepath", 'serveSnippets')这个不用生成函数
	//属性视图相关
...
/*	this.set("POST", "/api/filetree/getRefCreateSavePath",  getRefCreateSavePath)
